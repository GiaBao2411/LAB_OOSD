...
namespace QuanLyThuVien.Forms
{
    public partial class FrmSach : Form
    {
        ...
        {
            cboTheLoai.DataSource = danhMuc.LayTheLoai(); cboTheLoai.DisplayMember = "TenTheLoai"; cboTheLoai.ValueMember =
            "MaTheLoai";
            cboNXB.DataSource = danhMuc.LayNhaXuatBan(); cboNXB.DisplayMember = "MaNhaXuatBan"; cboNXB.ValueMember =
            "MaNhaXuatBan";
            TaiDuLieu(); LamMoi();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Xóa đầu sách đang chọn?", "Xác nhận", MessageBoxButtons.YesNo, MessageBoxIcon.Question) ==
            DialogResult.Yes)
