...
namespace QuanLyThuVien.Forms
{
    public partial class FrmMuonTra : Form
    {
        ...
        private void btnThemSach_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow row in selectedBooks.Rows) if (string.Equals(Convert.ToString(row["MaDauSach"]), ma,
            StringComparison.OrdinalIgnoreCase)) { MessageBox.Show("Đầu sách này đã có trong danh sách mượn."); return; }
        ...
        private void btnLapPhieu_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(kq.ThongBao, kq.ThanhCong ? "Thông báo" : "Lỗi", MessageBoxButtons.OK, kq.ThanhCong ?
        ...
        private void btnTraSach_Click(object sender, EventArgs e)
        {
            ...
            KetQuaXuLy kq = service.TraSach(maCT, MaNhanVienTra, dtNgayTra.Value, Convert.ToString(cboTinhTrang.SelectedItem),
            numPhiPhat.Value);
            MessageBox.Show(kq.ThongBao, kq.ThanhCong ? "Thông báo" : "Lỗi", MessageBoxButtons.OK, kq.ThanhCong ?
            MessageBoxIcon.Information : MessageBoxIcon.Warning);
